...
export const SUBJECT_SIM_COLORS: Record<string, { bg: string; text: string; border: string }> = {
  ...
  '物理工具': { bg: 'rgba(24,144,255,.08)', text: '#1890ff', border: 'rgba(24,144,255,.2)' },
...
export const PHET_SIMS: PhETSim[] = [
  ...
  { id: 'p11', name: '抛体运动', description: '调节发射角度、速度和高度，观察射程与轨迹变化，适合讲解运动合成。', grade: ['初二', '初三'], subject: '物理', simId: 'projectile-motion', hasChinese: true, tags: ['抛体运动', '速度', '角度', '轨迹'] },
  { id: 'p12', name: '摆实验室', description: '改变摆长、质量和重力条件，探究单摆周期与影响因素。', grade: ['初二', '初三'], subject: '物理', simId: 'pendulum-lab', hasChinese: true, tags: ['单摆', '周期', '重力'] },
  { id: 'p13', name: '弹簧与质量', description: '观察弹簧振动、伸长量和能量变化，辅助理解弹性势能和振动。', grade: ['初二', '初三'], subject: '物理', simId: 'masses-and-springs', hasChinese: true, tags: ['弹簧', '振动', '弹性势能'] },
  { id: 'p14', name: '欧姆定律', description: '调节电压和电阻，直观看到电流变化，适合电学基础课前演示。', grade: ['初三'], subject: '物理', simId: 'ohms-law', hasChinese: true, tags: ['欧姆定律', '电压', '电流', '电阻'] },
  { id: 'p15', name: '波动入门', description: '从水波、声波、光波等角度理解波的传播、振幅和频率。', grade: ['初二', '初三'], subject: '物理', simId: 'waves-intro', hasChinese: true, tags: ['波', '振幅', '频率'] },
  { id: 'p16', name: '几何光学', description: '用透镜、光源和屏幕搭建成像实验，帮助理解凸透镜成像规律。', grade: ['初二', '初三'], subject: '物理', simId: 'geometric-optics', hasChinese: true, tags: ['透镜', '成像', '光路'] },
  { id: 'c06', name: '配平化学方程式', description: '通过天平和粒子数量配平反应方程，强化质量守恒观念。', grade: ['初三'], subject: '化学', simId: 'balancing-chemical-equations', hasChinese: true, tags: ['方程式', '配平', '质量守恒'] },
  { id: 'c07', name: 'pH 标尺', description: '比较常见溶液的酸碱性，观察稀释后 pH 的变化。', grade: ['初三'], subject: '化学', simId: 'ph-scale', hasChinese: true, tags: ['pH', '酸碱', '稀释'] },
  { id: 'c08', name: '浓度', description: '改变溶质和水量，观察溶液颜色和浓度读数变化。', grade: ['初三'], subject: '化学', simId: 'concentration', hasChinese: true, tags: ['浓度', '溶质', '溶剂'] },
  { id: 'c09', name: '分子形状', description: '拖动原子和孤电子对，理解分子空间构型与键角。', grade: ['初三'], subject: '化学', simId: 'molecule-shapes', hasChinese: true, tags: ['分子', '键角', '空间构型'] },
  { id: 'c10', name: '同位素与原子质量', description: '通过同位素丰度理解平均原子质量的来源。', grade: ['初三'], subject: '化学', simId: 'isotopes-and-atomic-mass', hasChinese: true, tags: ['同位素', '原子质量', '丰度'] },
  { id: 'm07', name: '数轴：整数', description: '在数轴上移动点，理解正负数、距离和大小比较。', grade: ['初一'], subject: '数学', simId: 'number-line-integers', hasChinese: true, tags: ['数轴', '整数', '正负数'] },
  { id: 'm08', name: '数轴：距离', description: '用可视化方式理解绝对值、距离和两点间关系。', grade: ['初一', '初二'], subject: '数学', simId: 'number-line-distance', hasChinese: true, tags: ['数轴', '距离', '绝对值'] },
  { id: 'm09', name: '曲线拟合', description: '通过散点和拟合曲线理解函数模型与数据趋势。', grade: ['初二', '初三'], subject: '数学', simId: 'curve-fitting', hasChinese: true, tags: ['数据', '函数', '拟合'] },
  { id: 'm10', name: '三角函数之旅', description: '用单位圆和图像联动理解正弦、余弦和周期变化。', grade: ['初三'], subject: '数学', simId: 'trig-tour', hasChinese: true, tags: ['三角函数', '单位圆', '周期'] },
  {
    id: 'geogebra-3d-calculator',
    name: 'GeoGebra 3D 计算器',
    subject: '数学',
    category: '数学工具',
    grade: ['初二', '初三'],
    description: '适合立体几何、空间坐标、截面和旋转体演示，帮助学生把平面图形过渡到空间想象。',
    tags: ['立体几何', '空间坐标', '3D'],
    provider: 'geogebra',
    sourceUrl: 'https://www.geogebra.org/3d?lang=zh_CN',
    embedUrl: 'https://www.geogebra.org/3d?lang=zh_CN',
    language: 'zh_CN',
    featured: true,
  },
  {
    id: 'geogebra-cas-calculator',
    name: 'GeoGebra CAS 计算器',
    subject: '数学',
    category: '数学工具',
    grade: ['初二', '初三'],
    description: '用于代数变形、方程求解和函数验证，适合老师备课演示与学生探究。',
    tags: ['代数', '方程', '函数'],
    provider: 'geogebra',
    sourceUrl: 'https://www.geogebra.org/cas?lang=zh_CN',
    embedUrl: 'https://www.geogebra.org/cas?lang=zh_CN',
    language: 'zh_CN',
    featured: true,
  },
  {
    ...
    category: '数学工具',
    grade: ['初一', '初二', '初三'],
    description: '适合科学记数法、根式、三角函数和课堂快速计算验证。',
    tags: ['计算器', '科学记数法', '三角函数'],
    provider: 'desmos',
    sourceUrl: 'https://www.desmos.com/scientific?lang=zh-CN',
    embedUrl: 'https://www.desmos.com/scientific?lang=zh-CN',
    language: 'zh_CN',
  },
  {
    id: 'falstad-circuitjs',
    name: 'Falstad 电路仿真器',
    subject: '物理',
    category: '物理工具',
    grade: ['初三'],
    description: '可搭建电路、观察电流方向和电压变化，适合电学拓展、串并联和电容电感演示。',
    tags: ['电路', '电流', '电压', '拓展'],
    provider: 'external',
    sourceUrl: 'https://www.falstad.com/circuit/circuitjs.html',
    embedUrl: 'https://www.falstad.com/circuit/circuitjs.html',
    language: 'en',
    featured: true,
  },
  {
    id: 'chemcollective-virtual-labs',
    name: 'ChemCollective 化学虚拟实验室',
    subject: '化学',
    category: '化学实验室',
    grade: ['初三'],
    description: '覆盖酸碱、溶解度、氧化还原、热化学等虚拟实验，适合作为课前预习和拓展实验入口。',
    tags: ['虚拟实验', '酸碱', '滴定', '溶液'],
    provider: 'external',
    sourceUrl: 'https://chemcollective.org/vlabs',
    embedUrl: 'https://chemcollective.org/vlabs',
    externalOnly: true,
    language: 'en',
    featured: true,
  },
  {
    id: 'chemcollective-autograded-labs',
    name: 'ChemCollective 自动批改实验',
    subject: '化学',
    category: '化学实验室',
    grade: ['初三'],
    description: '提供带任务目标的虚拟化学实验，适合老师布置探究任务后让学生提交结果。',
    tags: ['自动批改', '实验任务', '酸碱'],
    provider: 'external',
    sourceUrl: 'https://chemcollective.org/autograded',
    embedUrl: 'https://chemcollective.org/autograded',
    externalOnly: true,
    language: 'en',
  },
]
...
export const SIM_PROVIDERS = ['phet', 'desmos', 'geogebra', 'external'] as const
