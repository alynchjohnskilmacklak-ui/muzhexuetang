...
export function getTodaySchedules(): TodaySchedule[] {
  return [
    { time: '08:30-10:00', courseName: '钢琴基础班', teacher: '王老师', room: '琴房A', subject: '音乐', students: 8 },
    { time: '10:15-11:45', courseName: '数学提高班', teacher: '李老师', room: '教室201', subject: '数学', students: 15 },
    { time: '13:30-15:00', courseName: '英语口语班', teacher: '张老师', room: '教室302', subject: '英语', students: 12 },
    { time: '15:15-16:45', courseName: '编程Scratch', teacher: '赵老师', room: '机房B', subject: '编程', students: 10 },
    { time: '19:00-20:30', courseName: '美术素描', teacher: '陈老师', room: '画室', subject: '美术', students: 6 },
  ]
}
