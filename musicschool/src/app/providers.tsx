        ...
        theme={{
          ...
          components: {
            Button: {
              ...
              controlHeight: 38,
              paddingInline: 16,
              primaryShadow: '0 4px 14px rgba(232,117,69,.3)',
              primaryColor: '#ffffff',
              defaultBg: '#ffffff',
            ...
            Input: {
              ...
              colorBorder: '#EFE3DC',
              hoverBorderColor: 'rgba(232,117,69,.5)',
              activeBorderColor: '#E87545',
            },
            Select: {
              borderRadius: 10,
              controlHeight: 38,
              ...
              optionSelectedBg: 'rgba(232,117,69,.08)',
            },
            Layout: {
              siderBg: '#faf8f5',
              headerBg: '#ffffff',
            ...
            Menu: {
              itemSelectedBg: 'rgba(232,117,69,.1)',
              itemSelectedColor: '#E87545',
              itemHoverBg: 'rgba(232,117,69,.04)',
            },
            Tag: {
              borderRadiusSM: 9999,
            },
